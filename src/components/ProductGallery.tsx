...
const products = [
  ...
  {
    icon: FileText,
    title: 'Planner para um Casamento Barato',
    description: 'Organize mês a mês com controle de tarefas, orçamento e prazos.',
    color: 'from-green-500 to-green-600'
  },
  {
    icon: Receipt,
    title: 'Declaração de Hipossuficiência',
    description: 'Modelo pronto para garantir isenção de taxas no casamento civil.',
  ...
  },
  {
    ...
    description: 'Crie convites digitais ou impressos com personalização rápida.',
  ...
  {
    icon: BookOpen,
    title: 'O Método do Casamento Barato',
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-white">
            ...
            <p className="text-base sm:text-lg opacity-90 mb-4 sm:mb-6">
              Valor total dos materiais: R$297,00 • Você economiza R$282,10
            </p>
            <button className="w-full sm:w-auto bg-white text-purple-800 font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              Quero todos os materiais agora
            </button>
          </div>
        </div>
      </div>
