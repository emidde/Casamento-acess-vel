        ...
        <div className="relative p-6 sm:p-8">
          ...
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8">
              Leve também todos os bônus por só <span className="text-pink-600 font-bold">R$19,90</span>
            </p>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
              ...
              <div className="space-y-2 sm:space-y-3 text-left">
                ...
                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 flex-shrink-0" />
                  <span className="text-sm sm:text-base">10 convites editáveis</span>
                </div>
                                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 flex-shrink-0" />
                  <span className="text-sm sm:text-base">Guia de enxoval com lista</span>
                </div>
                                                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 flex-shrink-0" />
                  <span className="text-sm sm:text-base">Guia dos melhores meses para casar</span>
                </div>
                                                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 flex-shrink-0" />
                  <span className="text-sm sm:text-base">Como funciona o casamento civil</span>
                </div>
                                                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 mr-2 sm:mr-3 flex-shrink-0" />
                  <span className="text-sm sm:text-base">Acesso a mais 4 bonus</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="text-center">
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-400 line-through">R$59,90</p>
              </div>
              <div className="text-center">
                <p className="text-sm text-pink-600">Neste momento seu desconto é de</p>
                <p className="text-2xl sm:text-3xl font-bold text-pink-600">+R$40</p>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              > <a href="https://pay.kiwify.com.br/oJ4g41z">Sim! Quero o pacote completo por R$19,90</a>
              ...
              > 
              <a href="https://pay.kiwify.com.br/aXfbpKn">Não, quero continuar com R$14,90 mesmo</a>
              </button>
            </div>
